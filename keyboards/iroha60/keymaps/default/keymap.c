...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
      ...
      RGB_TOG, RGBRST,  RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,
      _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______, _______,
